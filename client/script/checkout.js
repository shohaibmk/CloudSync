...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // domElementToastMeassge.innerHTML = "this is message";
  // toast.show();
  ...
  async function initialize() {
    ...
    const response = await fetch("http://127.0.0.1:3001/create-payment-intent", {
      method: "POST",
  ...
  async function handleSubmit(e) {
    ...
    const { error, paymentIntent } = await stripe.confirmPayment({
      ...
      confirmParams: {
        ...
        return_url: "http://127.0.0.1:3000/checkout",
        // receipt_email: id,
      },
    ...
    if (error) {//.type === "card_error" || error.type === "validation_error") {
      ...
      const url = 'http://127.0.0.1:3004/createUser';
